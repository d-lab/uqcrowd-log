...
// (tom) set experiment ID
params["expId"] = "tom";  // replace "tom" with your experiment ID (if used as standalone version). Ideal format could be string+date, e.g., abcde191231
...
hit_id = params["hitId"];
exp_id = params["expId"];
if (typeof(exp_id_preDefined) != "undefined" && exp_id_preDefined && exp_id_preDefined != ""){
    exp_id = exp_id_preDefined;
}
